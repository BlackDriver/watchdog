...
HD_PWD='C:/Users/WANGHONGYI/Desktop/zynq/led/led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log WatchDog.vdi -applog -m64 -messageDb vivado.pb -mode batch -source WatchDog.tcl -notrace
