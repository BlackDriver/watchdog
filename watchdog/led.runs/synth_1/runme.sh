...
HD_PWD='C:/Users/WANGHONGYI/Desktop/zynq/led/led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WatchDog.vds -m64 -mode batch -messageDb vivado.pb -notrace -source WatchDog.tcl
